...
Seal rates cross at about 2500 GiB. Pure blake2s advantage increases linearly.

Clearly, past the critical point, pure blake2s provides better performance.
...
```{python}
minimum_viable_sector_size_for_hybrids(filecoin_scaling_requirements, x1e32)
```
